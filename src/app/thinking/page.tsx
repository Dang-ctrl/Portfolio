...
const BOOKS = [
  ...
  { title: "How to Start a Cult", author: "Kristian Wilson", tag: "Belief systems", note: "The best products don't just have users — they have believers. Understanding how loyalty is engineered changes how you build anything." },
];
...
const INFLUENCES = [
  ...
  { name: "Nikhil Kamath", field: "Business / Finance", note: "First principles thinking in markets" },
  { name: "Brian Chesky", field: "Product / Experience", note: "Design-led company building" },
];
...
export default function ThinkingPage() {
  ...
  return (
    <main ref={ref} className="page-wrap">
      ...
      {/* influences */}
      <p className="reveal" style={{ fontFamily: "var(--font-mono)", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--sec)", margin: "36px 0 12px", paddingTop: "28px", borderTop: "0.5px solid var(--bdr)", transitionDelay: "320ms" }}>
        People I study
      </p>
